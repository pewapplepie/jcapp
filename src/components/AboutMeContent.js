...
const AboutMeContent = ({ className = "" }) => {
  return (
    <section
      className={`w-[90%] overflow-hidden shrink-0 flex flex-col items-start justify-start pt-0 px-0 pb-10 box-border gap-16 max-w-full text-left text-3xl text-black font-inter ${className}`}
    >
      <div className="self-stretch flex flex-col items-center justify-start gap-5 max-w-full">
        ...
        <div className="self-stretch text-xl leading-relaxed text-gray-800">
          ...
          <p className="m-0 pt-8">
            ...
            <li>researching novel machine learning models for financial data and large-scale/unstructured data analysis </li>
